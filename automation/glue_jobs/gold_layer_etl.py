...
GOLD_KPI_SONG_PATH = ("s3://spotify-lake-dev-data/gold/kpi_song/")

GOLD_KPI_ARTIST_PATH = ("s3://spotify-lake-dev-data/gold/kpi_artist/")

GOLD_COUNTRY_PERFORMANCE_PATH = ("s3://spotify-lake-dev-data/gold/country_performance/")

GOLD_MONTHLY_TRENDS_PATH = ("s3://spotify-lake-dev-data/gold/monthly_trends/")

GOLD_LABEL_PERFORMANCE_PATH = ("s3://spotify-lake-dev-data/gold/label_performance_enhanced/")
